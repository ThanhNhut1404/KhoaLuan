    ...
    <div class="panel-body card-body">
        ...
        <form id="editSemesterForm" method="POST" action="?page=edit_semester&id=<?= $id ?>">
            ...
            <div class="form-actions">
                <a href="?page=list_semester" class="action-btn secondary cancel-btn btn btn-outline-secondary">Hủy</a>
                <button type="submit" class="action-btn primary save-change-btn btn btn-primary">Cập nhật học kỳ</button>
            </div>
        </form>
    </div></div>
</div>
