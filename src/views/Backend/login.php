...
<style>
    ...
    :root{ --brand:#0f2a5a; --brand-2:#0b1f45; --muted:#6b7280; --ink:#0f172a; }
    * { box-sizing: border-box; }
    ...
    .login-wrapper {
        ...
        background:
            radial-gradient(600px 260px at 8% 12%, rgba(15, 42, 90, 0.18), transparent 70%),
            radial-gradient(520px 240px at 88% 10%, rgba(11, 31, 69, 0.18), transparent 72%),
    ...
    .login-left {
        padding:48px 52px;
        border-radius:18px;
        background: linear-gradient(135deg, #ecf2fb 0%, #ffffff 65%);
        min-height:550px;
        display:flex;
        flex-direction:column;
        justify-content:center;
    ...
    .login-left::after {
        ...
        width:220px;
        height:220px;
        background: radial-gradient(circle at center, rgba(15, 42, 90, 0.3) 0%, transparent 70%);
        opacity:0.8;
    }
    ...
    .form-control:focus { outline:none; border-color:#a8cdf5; box-shadow:0 0 0 4px rgba(15,42,90,0.12); }
    ...
    .modal-btn {
        ...
        font-weight: 700;
        color: #ffffff;
        background: linear-gradient(135deg, var(--brand), #0b1f45);
        cursor: pointer;
...
<div class="login-wrapper">
    ...
    <main class="login-page">
        <section class="login-left">
            <h1 class="welcome-title">Chào mừng<br>Quản trị viên</h1>
            <p class="welcome-sub">Đăng nhập để truy cập báo cáo vận hành, quản lý người dùng và theo dõi các cảnh báo quan trọng theo thời gian thực. Hệ thống bảo mật nhiều lớp để bảo vệ tài khoản quản trị.</p>
            <ul class="welcome-list">
                <li><span class="welcome-dot"></span>Quản lý sinh viên và hoạt động</li>
                <li><span class="welcome-dot"></span>Tra cứu dữ liệu toàn hệ thống</li>
                <li><span class="welcome-dot"></span>Bảo mật thông tin an toàn</li>
            </ul>
            ...
            <svg class="illustration" viewBox="0 0 640 220" xmlns="http://www.w3.org/2000/svg" fill="none" aria-hidden="true">
                <defs>
                    ...
                    <linearGradient id="g2" x1="0" y1="0" x2="1" y2="1">
                        <stop offset="0" stop-color="#0f2a5a" />
                        <stop offset="1" stop-color="#0b1f45" />
                    </linearGradient>
                </defs>
            ...
            <form method="post" action="#">
                ...
                <div class="form-row">
                    ...
                    <div class="pwd-wrap">
                        ...
                        <button type="button" id="toggleAdminPwd" class="toggle-btn" aria-label="Hiện mật khẩu">
