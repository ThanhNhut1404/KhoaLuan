...
<div class="student-form-page">
    <div class="page-panel card">
        ...
        <div class="panel-body card-body">
            <form method="post" action="/KhoaLuan/public/admin.php?page=edit_student&id=<?= htmlspecialchars($_GET['id'] ?? '') ?>">
                <div class="form-grid">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="action-btn primary btn btn-primary">Lưu thay đổi</button>
                </div>
            </form>
        </div>
    </div>
