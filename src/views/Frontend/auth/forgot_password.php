...
<main class="auth-page">
    <section class="auth-card card">
        <h1>Quên mật khẩu</h1>
        <p class="auth-note">Nhập email đã đăng ký để nhận mã OTP đặt lại mật khẩu.</p>

        <form method="post" action="/KhoaLuan/public/student.php?page=forgot_password" novalidate>
            <div class="mb-3">
            ...
            <div class="d-grid gap-3 mt-3">
                <button class="btn-submit btn btn-success" type="submit">Gửi mã OTP</button>
